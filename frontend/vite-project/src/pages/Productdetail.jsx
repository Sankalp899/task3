...
function Productdetail() {
  ...
  return productData ? (
    <>
  <div>
    <div className='lg:w-[100%] w-[100vw] min-h-[100%] md:h-[100%] bg-gradient-to-l from-[#141414]  to-[#0c2025] flex items-center justify-start flex-col lg:flex-row gap-[20px] pb-[20px]'>
        <div className='lg:w-[50vw] md:w-[90vw] lg:h-[90vh] h-[50vh] mt-[70px] flex items-center justify-center md:gap-[10px] gap-[30px] flex-col-reverse lg:flex-row'>
          <div className='lg:w-[20%] md:w-[80%] h-[10%] lg:h-[80%] flex items-center justify-center gap-[50px] lg:gap-[20px] lg:flex-col '>
        ...
        <div className='lg:w-[50vw] w-[100vw] lg:h-[75vh h-[40vh] mb-[230px] lg:mt-[80px] flex items-start justify-start flex-col py-[20px] px-[30px] md:pb-[20px] md:pl-[20px] lg:pl-[0px] lg:px-[0px] lg:py-[0px] gap-[10px]'>
          ...
          <p className=' w-[80%] text-[20px] font-semibold pl-[5px] text-[white]'>{productData.description} and stylish, breathable cotton shirt with a modren slim fit. Easy to wash, super comfortble, and designed for efforless style.</p>
        <div className='flex flex-col gap-[10px] my-[10px]'>
          ...
          <div className='flex gap-2'>
              {
                productData.sizes.map((item, index) =>(
                  <button key={index} className={`border py-2 px-4 bg-slate-300 rounded-md 
                    ${item === size ? 'bg-black text-[#267cc7] text-[20px]':''}`}
          ...
          <div>
           ...
           <div className='w-[500px] h-[1px] bg-slate-700'>
            </div>
            <div className='w-[90%] text-[16px] text-white'>
    ...
    <div className='w-[100%] min-h-[70vh] bg-gradient-to-l from-[#141414] to-[#0c2025] flex items-start justify-start flex-col overflow-hidden'>
            <div className='flex px-[20px] mt-[180px] lg:ml-[80px] ml-[0px] lg:mt-[0px]'>
              ...
              <div className='w-[80%] md:h-[150px] h-[220px] bg-[#3336397c] border text-white text-[13px] md:text-[15px] lg:text-[20px] px-[10px] md:px-[30px] lg:ml-[100px] ml-[20px]'>
                <p className='w-[95%] h-[90%] flex items-center justify-center'>
                  Upgrade your wardrobe with this stylish slim-fit cotton shirt, available now on SanpCart. Crafted from breathable, high-quality fabric, it offers all-day comfort and effortless style. Easy to maintain and perfect for any setting, this shirt is a must-have essential for those who value fashion and function.  
                </p>
              </div>
              <Relatedproduct category={productData.category} subCatagory={productData.subCatagory} currentProductId={productData._id} />
    </div>
  </div>
    </>
